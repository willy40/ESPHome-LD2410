...
namespace esphome
{
  namespace ld2410s
  {
    ...
    public:
      ...
      void set_gate_index(uint8_t gate) { this->gate_index_ = gate; }
      void setup() override {}
    ...
    public:
      ...
      void set_gate_energies(const uint16_t energies[NUM_GATES]);
      ...
      // write sliders
      void set_gate_energy_write_number(uint8_t gate, LD2410SNumber *n)
      {
        if (gate < NUM_GATES)
          this->gate_energy_write_[gate] = n;
      }
    ...
    protected:
      ...
      uint8_t rx_peek_(size_t offset) const;
      void rx_drop_(size_t n);
      void rx_extract_(uint8_t *out, size_t len);
      ...
      static constexpr size_t ACK_FRAME_MAX_LEN = 64;
      static constexpr size_t STANDARD_FRAME_MIN_LEN = 80;
      static constexpr size_t STANDARD_FRAME_MAX_LEN = 96;
      ...
      LD2410SNumber *gate_energy_write_[NUM_GATES]{};
      ...
      uint16_t pending_gate_energies_[NUM_GATES] = {0};
    };
